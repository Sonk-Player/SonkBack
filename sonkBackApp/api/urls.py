...
from .views import SearchMusic,GetArtist,GetSong,GetSudggest,GetTopSongs,GetPlaylistTop,SearchMusicWithPage,GetMoodCategories,GetPlaylist, GetAutoComplete
